    ...
    <div style={{
      ...
      {entered && (
        <div style={{
          ...
          background: "linear-gradient(135deg, rgba(0,0,30,0.98) 0%, rgba(10,5,40,0.96) 100%)", backdropFilter: "blur(20px)",
          ...
          <div style={{ position: "relative", width: 200, height: 200, animation: "rotatePlanet 12s linear infinite" }}>
            <div style={{
              position: "absolute", inset: 0, borderRadius: "50%",
              background: "radial-gradient(circle at 35% 35%, #2a4a8c 0%, #1a2e5a 30%, #0d1a3a 55%, #060d20 80%, #020508 100%)",
              boxShadow: "0 0 60px 15px rgba(40,80,200,0.3), inset -20px -15px 40px rgba(0,0,0,0.6), inset 10px 10px 30px rgba(60,100,200,0.1)",
              overflow: "hidden",
            }}>
              <div style={{ position: "absolute", inset: 0, borderRadius: "50%", background: "radial-gradient(circle at 30% 30%, rgba(100,160,255,0.12) 0%, transparent 60%)" }} />
            </div>
            ...
            <div style={{
              position: "absolute", inset: -20, borderRadius: "50%",
              border: "2px solid rgba(79,195,247,0.3)", animation: "pulse 3s ease-in-out infinite",
            }} />
          </div>
          ...
          <div style={{
            ...
            background: "rgba(5,15,50,0.6)", border: "1px solid rgba(79,195,247,0.3)",
            borderRadius: 12, padding: "20px 24px", backdropFilter: "blur(12px)",
          }}>
            <div style={{
              fontSize: 10, letterSpacing: "0.2em", color: "rgba(79,195,247,0.8)", textTransform: "uppercase",
          ...
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: 28, fontWeight: 800, letterSpacing: "0.1em", color: "#4fc3f7", marginBottom: 12, fontFamily: "monospace" }}>
              {countdown}
            </div>
          ...
          <div style={{ width: 220, height: 3, background: "rgba(60,90,180,0.2)", borderRadius: 2, overflow: "hidden" }}>
            <div style={{
              height: "100%", background: "linear-gradient(90deg, #4fc3f7, #a78bfa)",
              width: `${((6 - countdown) / 6) * 100}%`, transition: "width 1s linear", borderRadius: 2,
